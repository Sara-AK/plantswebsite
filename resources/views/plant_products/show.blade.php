...
<!-- Mirrored from iideainformatics.it/html/devgalaxy/devgren/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2024 06:54:35 GMT -->
...
<body>
                ...
                <div class="header-wrapper">
                    ...
                    <ul class="main-menu">
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="http://plantswebsite.test/plantproducts/1">Service One</a></li>
                                <li><a href="http://plantswebsite.test/plantproducts/1">Service Two</a></li>
                                <li><a href="http://plantswebsite.test/plantproducts/1">Service Details</a></li>
                            </ul>
                        </li>
                        <li>
    ...
    <main>
        ...
        <section class="page-banner bg-image pt-130 pb-130">
            <div class="container">
                <h2 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">Animal Resque</h2>
                <div class="breadcrumb-list wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">
                    <a href="index-2.html">Home :</a>
                    <a class="primary-color" href="service-2.html">services 02 :</a>
                    <span class="primary-color">Animal Resque</span>
                </div>
            </div>
        </section>
        ...
        <section class="service-single pt-130 pb-130">
            <div class="container">
                <div class="row g-4">
                    <div class="col-lg-8">
                        <div class="service-single__left-item">
                            <div class="image">
                                <img src="assets/images/service/single1.jpg" alt="image">
                            </div>
                            <h3 class="text-capitalize mt-40 mb-30">Feed & Care For Shelter Animals Every Day!</h3>
                            ...
                            <p class="mt-30 mb-40">Praesent eget mollis nulla, non lacinia urna. Donec sit amet neque
                                auctor, ornare dui
                            ...
                            <h3 class="text-capitalize mb-30">Modern Service Standard</h3>
                            <div class="row g-4">
                                <div class="col-md-6">
                                    <div class="image">
                                        <img src="assets/images/service/single2.jpg" alt="image">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="image">
                                        <img src="assets/images/service/single3.jpg" alt="image">
                                    </div>
                                </div>
                            </div>
                            <p class="mt-3">Praesent eget mollis nulla, non lacinia urna. Donec sit amet neque
                                auctor,
                                ornare dui
                                rutrum, condimentum justo. Duis
                                dictum, ex accumsan eleifend eleifend, ex justo aliquam nunc, in ultrices ante quam eget
                    ...
                    <div class="col-lg-4">
                        <div class="service-single__right-item">
                            <div class="item-one mb-30 pb-30">
                                <div class="image">
                                    <img src="assets/images/service/single4.png" alt="image">
                                </div>
                                <h3>Available</h3>
                            ...
                            <div class="item-two bg-image mb-30" data-background="assets/images/service/single5.jpg">
                                <div class="wrp">
                                    ...
                                    <h3 class="text-capitalize mt-2 mb-30">
                                        call us today!</h3>
                                    <div class="line"><span class="sm_line"></span> <span class="big_line"></span>
                                    </div>
                                    <a href="tel:+020261259870">+02 026 125 9870</a>
                                </div>
                            </div>
                            <div class="item-three sub-bg">
                                ...
                                <a href="#0"><i class="fa-solid fa-arrow-down"></i> Download Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="page-service sub-bg pt-130 pb-130">
            <div class="container">
                <div class="row g-4 align-items-center">
                    <div class="col-xl-6">
                        <div class="page-service__right-item">
                            <div class="section-header mb-5">
                                <h5 class="wow fadeInUp" data-wow-duration="1.2s" data-wow-delay=".2s">SERVICE
                                    BENEFITS
                                </h5>
                                <h2 class="wow fadeInUp" data-wow-duration="1.4s" data-wow-delay=".4s">Benefit of
                                    Service</h2>
                                <p class="wow fadeInUp " data-wow-duration="1.6s" data-wow-delay=".6s">Praesent eget
                            ...
                            <div class="row g-4">
                                <div class="col-sm-6 wow fadeInLeft" data-wow-duration="1.3s" data-wow-delay=".3s">
                                    <ul>
                                        <li><i class="fa-solid mb-4 me-2 primary-color fa-gear"></i> Make strond your
                                            roof
                                        </li>
                                        <li><i class="fa-solid me-2 primary-color fa-gear"></i> Door and Windows will
                                            good
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 wow fadeInRight" data-wow-duration="1.4s" data-wow-delay=".4s">
                                    <ul>
                                        <li><i class="fa-solid mb-4 me-2 primary-color fa-gear"></i> Door and Windows
                                            will good
                                        </li>
                                        <li><i class="fa-solid me-2 primary-color fa-gear"></i> Make strond your roof
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".5s">
                                    <ul>
                                        <li><i class="fa-solid mb-4 me-2 primary-color fa-gear"></i> No any leakes in
                                            roof
                                        </li>
                                        <li><i class="fa-solid me-2 primary-color fa-gear"></i> Maintain your home
                                            structure
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-sm-6 wow fadeInRight" data-wow-duration="1.6s" data-wow-delay=".6s">
                                    <ul>
                                        <li><i class="fa-solid mb-4 me-2 primary-color fa-gear"></i> Maintain your home
                                            structure
                                        </li>
                                        <li><i class="fa-solid me-2 primary-color fa-gear"></i> No any leakes in roof
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-6">
                        <div class="image position-relative">
                            <img src="assets/images/service/single6.jpg" alt="image">
                        ...
                        <div class="footer__item">
                            ...
                            <ul>
                                <li class="pb-1"><a href="service-single.html"><i
                                            class="fa-solid fa-chevron-right pe-1 primary-color"></i> Water
                                        Conservation
                                    </a>
                                </li>
                                <li class="pb-1"><a href="service-single.html"><i
                                ...
                                <li class="pb-1"><a href="service-single.html"><i
                                            class="fa-solid fa-chevron-right pe-1 primary-color"></i> Plastic
                                        Recycleing
                                    </a>
                                </li>
                                <li class="pb-1"><a href="service-single.html"><i
...
<!-- Mirrored from iideainformatics.it/html/devgalaxy/devgren/service-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 29 Aug 2024 06:54:36 GMT -->
