                        ...
                        <div class="footer__item">
                            ...
                            <ul>
                                <li class="pb-3"><a href="#0"><i
                                            class="fa-solid fa-location-dot pe-1 primary-color"></i> 901 N Pitt Str.,
                                        Suite 170 Alexandria, <br> USA</a></li>
                                <li class="pb-3"><a href="tel:+4065550120"><i
                                            class="fa-solid fa-phone-volume pe-1 primary-color"></i> (406) 555-0120</a>
                                </li>
                                <li><a href="#0"><i class="fa-solid fa-envelope pe-1 primary-color"></i>
                                        info@extrem.com</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="footer__item">
                            ...
                            <ul>
                                <li class="pb-1"><a href="service-single.html"><i
                                        ...
                                        Conservation</a></li>
                                <li class="pb-1"><a href="service-single.html"><i
                                            class="fa-solid fa-chevron-right pe-1 primary-color"></i> Eco System</a>
                                </li>
                                <li class="pb-1"><a href="service-single.html"><i
                                            class="fa-solid fa-chevron-right pe-1 primary-color"></i> Plastic
                                        Recycling</a></li>
                                <li class="pb-1"><a href="service-single.html"><i
                                            class="fa-solid fa-chevron-right pe-1 primary-color"></i> Urban planning</a>
                                </li>
                    ...
                    <div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-duration="1.8s" data-wow-delay=".8s">
                        <div class="footer__item">
                            ...
                            <ul class="footer__item-blog">
                                <li class="pb-3">
                                    <img src="{{ asset('assets/images/footer/01.png') }}" alt="image">
                                    <div class="ms-3">
                                ...
                                <li>
                                    <img src="{{ asset('assets/images/footer/02.png') }}" alt="image">
                                    <div class="ms-3">
                                        <h4><a href="blog-single.html">Close up picture of the sapling</a></h4>
                                        <span>2 weeks ago</span>
                                    </div>
